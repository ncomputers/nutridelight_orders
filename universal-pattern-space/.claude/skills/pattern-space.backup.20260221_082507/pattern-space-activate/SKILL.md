...
Load from the installed `pattern-space/perspectives/` skill directory:
- **Trinity (90% coverage):**
...
Load from the installed `pattern-space/field/` skill directory:
...
Load from the installed `pattern-space/transformation/` skill directory:
...
Available from the installed `pattern-space/archaeology/` skill directory:
...
Available from the installed `pattern-space/wisdom/` skill directory:
